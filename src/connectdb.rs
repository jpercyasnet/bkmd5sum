...
//                bolok = false;
                ...
                if !(collist == "refname,filename,dirname,filesize,filedate,md5sum") {
                    println!("column list of {} instead of refname,filename,dirname,filesize,filedate,md5sum", collist);
                    let errstr4 = format!("column list of {} instead of refname,filename,dirname,filesize,filedate,md5sum", collist);
